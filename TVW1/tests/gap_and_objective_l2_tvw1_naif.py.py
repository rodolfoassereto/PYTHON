...
from l2_tvw1_naif import compute_C_bounds, model_naif, model_naif_graph, objective_l2_tvw1_naif, primal_dual_gap
...
def objective_fn(x_list):
    ...
    return objective_l2_tvw1_naif(P, shape_x, shape_y, ALPHA1, ALPHA2, KK, E)
...
np.random.seed(SEED)
x, _, history = model_naif_graph(E, mask_rfft, shape_x, shape_y, ALPHA1, ALPHA2, C_bounds,
                                  graph_params, SIGMA, IT_GRAPH,
                                  printprogress=True,
                                  extra_metrics_fn=extra_metrics_fn, record_every=RECORD)
