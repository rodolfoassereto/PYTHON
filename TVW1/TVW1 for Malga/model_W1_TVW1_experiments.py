...
image_prob_reg = model_W1_TVW1(image_noisy_prob, shape_image_prob_x, shape_image_prob_y, 0.4, 4000)

image_reg_fromW1 = convert_probabilities_into_pixels(image_prob_reg)

plt.close('all')
plt.imshow(image_reg_fromW1)
plt.show()
